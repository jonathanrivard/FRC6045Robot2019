...
public class Pusher extends Subsystem {
    ...
    public Pusher() {
        ...
        pusherMotor = new Spark(4);
        addChild("PusherMotor",pusherMotor);
        pusherMotor.setInverted(false);
        
        forwardLimitSwitch = new DigitalInput(9);
        addChild("ForwardLimitSwitch",forwardLimitSwitch);
        
        
        backwardLimitSwitch = new DigitalInput(8);
        addChild("BackwardLimitSwitch",backwardLimitSwitch);

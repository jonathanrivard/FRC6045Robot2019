...
public class ArcadeDriveWithJoystick extends Command {
    ...
    public ArcadeDriveWithJoystick() {
        drive = new DifferentialDrive(Robot.drivetrain.getLeftGroup(), Robot.drivetrain.getRightGroup());
    ...
    protected void initialize() {
        leftStick = Robot.oi.getJoystickOne();
    }
    ...
    protected void execute() {
        ...
        double first = Robot.oi.scaledGetX();
        //double second = (Robot.oi.getJoystickOne().getY());
        double second = Robot.oi.scaledGetY();
